...
GREEK_ADDITIONAL: Dict[str, GreekTerm] = {
    ...
    "θεός": GreekTerm(
        ...
        semantic_range=("God", "deity", "divine", "god"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("John 1:1", "John 1:18", "Romans 9:5"),
        hebrew_equivalent="אֱלֹהִים",
        cognates=("θεῖος", "θεότης"),
        motif_associations=("FIRE", "SILENCE"),
    ),
    "Χριστός": GreekTerm(
        term="Χριστός",
        transliteration="Christos",
        strongs="G5547",
        meaning="Christ, Anointed One, Messiah",
        semantic_range=("Christ", "Anointed", "Messiah"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.ULTRA,
        ...
        hebrew_equivalent="מָשִׁיחַ",
        cognates=("χρίω",),
        motif_associations=("LAMB", "SHEPHERD"),
    ),
    "πνεῦμα": GreekTerm(
        term="πνεῦμα",
        transliteration="pneuma",
        strongs="G4151",
        meaning="spirit, wind, breath",
        semantic_range=("spirit", "Spirit", "wind", "breath", "ghost"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("John 3:8", "John 4:24", "Romans 8:16"),
        hebrew_equivalent="רוּחַ",
        cognates=("πνέω",),
        motif_associations=("BREATH", "FIRE"),
    ),
    "ψυχή": GreekTerm(
        ...
        tense=None,
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("Matthew 10:28", "Matthew 16:26", "1 Peter 2:11"),
        hebrew_equivalent="נֶפֶשׁ",
        cognates=("ψύχω",),
        motif_associations=("BREATH",),
    ),
    "σάρξ": GreekTerm(
        ...
        strongs="G4561",
        meaning="flesh, body, human nature",
        semantic_range=("flesh", "body", "human nature", "carnal"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("John 1:14", "Romans 8:3", "Galatians 5:17"),
        hebrew_equivalent="בָּשָׂר",
        cognates=("σαρκικός",),
        motif_associations=(),
    ),
    "δόξα": GreekTerm(
        ...
        strongs="G1391",
        meaning="glory, honor, splendor",
        semantic_range=("glory", "honor", "splendor", "brightness", "praise"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("John 1:14", "John 17:5", "Romans 8:18"),
        hebrew_equivalent="כָּבוֹד",
        cognates=("δοξάζω",),
        motif_associations=("FIRE",),
    ),
    "εἰρήνη": GreekTerm(
        ...
        semantic_range=("peace", "harmony", "tranquility", "welfare"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.MAJOR,
    ...
    "ἐλπίς": GreekTerm(
        ...
        semantic_range=("hope", "expectation", "trust"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("Romans 5:5", "Romans 8:24", "1 Corinthians 13:13"),
        hebrew_equivalent="תִּקְוָה",
        cognates=("ἐλπίζω",),
        motif_associations=(),
    ),
    "πίστις": GreekTerm(
        ...
        strongs="G4102",
        meaning="faith, trust, belief",
        semantic_range=("faith", "trust", "belief", "faithfulness", "conviction"),
        part_of_speech=PartOfSpeech.NOUN,
        voice=None,
        tense=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Romans 1:17", "Galatians 2:16", "Hebrews 11:1"),
        hebrew_equivalent="אֱמוּנָה",
        cognates=("πιστεύω", "πιστός"),
        motif_associations=(),
    ),
...
# ============================================================================
# HEBREW ADDITIONAL EXTENDED
# ============================================================================

HEBREW_EXTENDED: Dict[str, HebrewTerm] = {
    "נֶפֶשׁ": HebrewTerm(
        term="נֶפֶשׁ",
        transliteration="nephesh",
        strongs="H5315",
        meaning="soul, living being, life",
        semantic_range=("soul", "life", "person", "self", "appetite"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Genesis 2:7", "Deuteronomy 6:5", "Psalm 42:1"),
        lxx_equivalent="ψυχή",
        cognates=(),
        motif_associations=("BREATH",),
    ),
    "רוּחַ": HebrewTerm(
        ...
        strongs="H7307",
        meaning="spirit, wind, breath",
        semantic_range=("spirit", "wind", "breath", "mind"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Genesis 1:2", "Genesis 6:3", "Ezekiel 37:9"),
        lxx_equivalent="πνεῦμα",
        cognates=("רָוַח",),
        motif_associations=("BREATH", "FIRE"),
    ),
    "קָדוֹשׁ": HebrewTerm(
        ...
        strongs="H6918",
        meaning="holy, sacred, set apart",
        semantic_range=("holy", "sacred", "set apart", "consecrated"),
        part_of_speech=PartOfSpeech.ADJECTIVE,
        verb_stem=None,
        root="קדש",
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Isaiah 6:3", "Leviticus 11:44", "Psalm 99:9"),
        lxx_equivalent="ἅγιος",
        cognates=("קֹדֶשׁ", "קָדַשׁ"),
        motif_associations=("FIRE", "SILENCE"),
    ),
    "בְּרִית": HebrewTerm(
        term="בְּרִית",
        transliteration="berit",
        strongs="H1285",
        meaning="covenant, alliance, pledge",
        semantic_range=("covenant", "treaty", "alliance", "agreement"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root=None,
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Genesis 9:9", "Genesis 15:18", "Jeremiah 31:31"),
        lxx_equivalent="διαθήκη",
        cognates=(),
        motif_associations=("BLOOD",),
    ),
    "גָּאַל": HebrewTerm(
        ...
        semantic_range=("redeem", "ransom", "avenge", "kinsman-redeemer"),
        part_of_speech=PartOfSpeech.VERB,
        verb_stem=VerbStem.QAL,
        root="גאל",
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Ruth 4:4", "Isaiah 43:1", "Isaiah 44:22"),
        lxx_equivalent="λυτρόω",
        cognates=("גֹּאֵל", "גְּאֻלָּה"),
        motif_associations=("BLOOD",),
    ),
    "כֹּהֵן": HebrewTerm(
        term="כֹּהֵן",
        ...
        strongs="H3548",
        meaning="priest",
        semantic_range=("priest", "chief minister", "principal officer"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="כהן",
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("Exodus 28:1", "Psalm 110:4", "Hebrews 5:6"),
        lxx_equivalent="ἱερεύς",
        cognates=("כְּהֻנָּה",),
        motif_associations=("BLOOD",),
    ),
    "מֶלֶךְ": HebrewTerm(
        ...
        strongs="H4428",
        meaning="king, ruler",
        semantic_range=("king", "ruler", "royal"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="מלך",
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("1 Samuel 8:5", "Psalm 2:6", "Isaiah 6:5"),
        lxx_equivalent="βασιλεύς",
        cognates=("מַלְכוּת", "מָלַךְ"),
        motif_associations=("SHEPHERD",),
    ),
    "נָבִיא": HebrewTerm(
        term="נָבִיא",
        ...
        semantic_range=("prophet", "spokesman", "inspired man"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="נבא",
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("Deuteronomy 18:15", "Amos 3:7", "Acts 3:22"),
        lxx_equivalent="προφήτης",
        cognates=("נְבוּאָה",),
        motif_associations=(),
    ),
    "כָּבוֹד": HebrewTerm(
        ...
        strongs="H3519",
        meaning="glory, honor, weight",
        semantic_range=("glory", "honor", "splendor", "weight", "abundance"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="כבד",
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Exodus 33:18", "Exodus 40:34", "Isaiah 6:3"),
        lxx_equivalent="δόξα",
        cognates=("כָּבֵד",),
        motif_associations=("FIRE",),
    ),
    "שָׁלוֹם": HebrewTerm(
        ...
        strongs="H7965",
        meaning="peace, completeness, welfare",
        semantic_range=("peace", "welfare", "health", "prosperity", "completeness"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="שׁלם",
        theological_weight=TheologicalWeight.MAJOR,
    ...
    "חֶסֶד": HebrewTerm(
        ...
        transliteration="chesed",
        strongs="H2617",
        meaning="steadfast love, mercy, lovingkindness",
        semantic_range=("lovingkindness", "mercy", "steadfast love", "loyalty", "covenant faithfulness"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="חסד",
        theological_weight=TheologicalWeight.ULTRA,
        key_verses=("Exodus 34:6", "Psalm 136:1", "Hosea 6:6"),
        lxx_equivalent="ἔλεος, χάρις",
        cognates=(),
        motif_associations=(),
    ),
    "אֱמֶת": HebrewTerm(
        ...
        semantic_range=("truth", "faithfulness", "reliability", "stability"),
        part_of_speech=PartOfSpeech.NOUN,
        verb_stem=None,
        root="אמן",
        theological_weight=TheologicalWeight.MAJOR,
        key_verses=("Exodus 34:6", "Psalm 25:5", "John 14:6"),
        lxx_equivalent="ἀλήθεια",
        cognates=("אָמֵן",),
        motif_associations=(),
    ),
}
...
ALL_HEBREW: Dict[str, HebrewTerm] = {**HEBREW_ULTRA, **HEBREW_MAJOR, **HEBREW_ADDITIONAL, **HEBREW_EXTENDED}
